...
public class GiveNewClassificationActivity extends AppCompatActivity {
    private EditText edtAddClassificationLast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_give_new_classification);
        ...
        edtAddClassificationLast = findViewById(R.id.edtAddClassificationLast);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cancel) {
            ...
            DatabaseExemplar exemplarDb = new DatabaseExemplar(this);
            exemplar.setClassificationLast(Float.parseFloat(edtAddClassificationLast.getText().toString()));
